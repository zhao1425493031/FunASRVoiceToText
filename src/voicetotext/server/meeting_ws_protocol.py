...
SUPPORTED_LANGUAGES = frozenset({"ja", "zh", "auto"})


class MeetingWSSession:
    """In-process SenseVoice streaming session."""
...
class MeetingWSProtocolHandler:
    """Meeting v2 handler (embedded Python ASR)."""
